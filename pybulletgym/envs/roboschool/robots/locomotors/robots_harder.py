...
class AntHarder(WalkerBase, MJCFBasedRobot):
...
class HalfCheetahHarder(WalkerBase, MJCFBasedRobot):
...
class HumanoidHarder(WalkerBase, MJCFBasedRobot):
    self_collision = True
...
class Walker2DHarder(WalkerBase, MJCFBasedRobot):
