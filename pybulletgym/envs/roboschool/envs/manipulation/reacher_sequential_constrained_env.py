...
import numpy as np
from pybulletgym.envs.roboschool.robots.manipulators.reacher_sequential_constrained import ReacherSequentialConstrained
import pybullet


class ReacherSequentialConstrainedBulletEnv(BaseBulletEnv):
    def __init__(self):
        self.robot = ReacherSequentialConstrained()
